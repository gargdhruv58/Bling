            ...
            public void onClick(View v) {
                if(continueBtn.getText().equals("Submit") || checker.equals("Code Sent"))
                {
                    ...
                    if(!phoneNumber.equals(""))
                    {
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNumber,120,TimeUnit.SECONDS,RegistrationActivity.this,mCallbacks);

                    }
                    else{
                        Toast.makeText(RegistrationActivity.this, "Plaese enter a valid phone number!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
